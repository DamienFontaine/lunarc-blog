...
func BeforeEach() {
	...
	articleService = ArticleService{MongoService: mongo.Service{Mongo: *m}}
}
...
func TestGetByIdNormal(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("Mustn't return an error: %v", err)
	}

	if reflect.DeepEqual(article, model.Article{}) {
...
func TestAddNormal(t *testing.T) {
	...
	article := model.Article{Titre: "New Article"}
...
func TestUpdateNormal(t *testing.T) {
	...
	article := model.Article{Titre: oldTitle}
...
func TestUpdateBadIdError(t *testing.T) {
	...
	article := model.Article{Titre: "Le titre"}
...
func TestDeleteNormal(t *testing.T) {
	...
	article := model.Article{Titre: "New Article Delete"}
	article, _ = articleService.Add(article)
