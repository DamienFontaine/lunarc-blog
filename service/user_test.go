...
func TestUserAddNormal(t *testing.T) {
	...
	user := model.User{User: security.User{Username: "Test", Password: "test"}}
...
func TestUserUpdateNormal(t *testing.T) {
	...
	user := model.User{User: security.User{Username: oldUsername}}
	user, err := userService.Add(user)
...
func TestUserUpdateBadIdError(t *testing.T) {
	...
	user := model.User{User: security.User{Username: "NewUserTest3"}}
...
func TestUserDeleteNormal(t *testing.T) {
	...
	user := model.User{User: security.User{Username: "NewUserTest4"}}
	user, err := userService.Add(user)
...
func TestUserDeleteBadIdError(t *testing.T) {
	...
	user := model.User{User: security.User{Username: "NewUserTest5"}}
